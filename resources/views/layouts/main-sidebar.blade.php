			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='users') }}">قائمة المشرفين</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='roles') }}">صلاحيات المشرفين</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='posts') }}">اضافة مقالة</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='edit_posts') }}">العمليات على المقالة</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='show_activities') }}">قائمة الأنشطة</a></li>
