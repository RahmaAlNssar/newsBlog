			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							@can('قائمة المشرفين')<li><a class="slide-item" href="{{ url('/' . $page='users') }}">قائمة المشرفين</a></li>@endcan
							@can('صلاحيات المشرفين')<li><a class="slide-item" href="{{ url('/' . $page='roles') }}">صلاحيات المشرفين</a></li>@endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='index') }}">قائمة الأقسام</a></li>
					...
					@can('المقالات')
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M4 12c0 4.08 3.06 7.44 7 7.93V4.07C7.05 4.56 4 7.92 4 12z" opacity=".3"/><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.94-.49-7-3.85-7-7.93s3.05-7.44 7-7.93v15.86zm2-15.86c1.03.13 2 .45 2.87.93H13v-.93zM13 7h5.24c.25.31.48.65.68 1H13V7zm0 3h6.74c.08.33.15.66.19 1H13v-1zm0 9.93V19h2.87c-.87.48-1.84.8-2.87.93zM18.24 17H13v-1h5.92c-.2.35-.43.69-.68 1zm1.5-3H13v-1h6.93c-.04.34-.11.67-.19 1z"/></svg><span class="side-menu__label">المقالات</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							
							@can('اضافة مقالة')<li><a class="slide-item" href="{{ url('/' . $page='posts') }}">اضافة مقالة</a></li>@endcan
							@can('مشاركة فيسبوك')<li><a class="slide-item" href="{{ url('/' . $page='socialMedia_post_create') }}"> اضافة من فيسبوك</a></li>@endcan
							
							@can('العمليات على المقالات')<li><a class="slide-item" href="{{ url('/' . $page='edit_posts') }}">العمليات على المقالة</a></li>@endcan
						
						</ul>
					</li>
					@endcan
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M6.26 9L12 13.47 17.74 9 12 4.53z" opacity=".3"/><path d="M19.37 12.8l-7.38 5.74-7.37-5.73L3 14.07l9 7 9-7zM12 2L3 9l1.63 1.27L12 16l7.36-5.73L21 9l-9-7zm0 11.47L6.26 9 12 4.53 17.74 9 12 13.47z"/></svg><span class="side-menu__label">النشاطات</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							@can('عرض الأنشطة')<li><a class="slide-item" href="{{ url('/' . $page='show_activities') }}">قائمة الأنشطة</a></li>@endcan
